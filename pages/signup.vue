                ...
                <div
                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" @submit.prevent="handleRegister">
                            <SharedInput type="text" label="Name" v-model="user.name" placeholder="Name"/>
                            <SharedInput type="text" label="Email" v-model="user.email" placeholder="Email"/>
                            <SharedInput type="password" label="Password" v-model="user.password" placeholder="Password" />
                            <SharedInput type="password" label="Confirm Password" v-model="user.repeatPassword" placeholder="Confirm Password" />
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="terms" v-model="term" aria-describedby="terms" type="checkbox"
