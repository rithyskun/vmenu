...
<template>
  <div id="modal-backdrop" class="fixed p-1 inset-0 z-40 flex items-center justify-center bg-gray-700 bg-opacity-90">
    <div
      id="modal"
      class="relative flex w-full md:w-3/6 lg:w-2/6 h-5/6 lg:h-5/6 flex-col justify-between rounded-md bg-gray-50 dark:bg-gray-500 dark:text-white"
    >
